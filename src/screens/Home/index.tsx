...
export function Home() {
    ...
    function handleTaskAdd() {
        if(!newTask.trim()){
            return Alert.alert("Erro", "Tarefa vazia, digite um texto.")
        }

        if(newTask.length < 5){
            return Alert.alert("Erro", "Digite um texto maior que 4 caracteres.")
        }
            ...
            <View style={styles.tasksContainer}>
                <View style={styles.info}>
                    <View style={styles.row}>
                        <Text style={styles.tasksCreated}>Criada</Text>
